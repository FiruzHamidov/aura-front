export interface Developer { id: number; name: string }
export interface ConstructionStage { id: number; name: string }
export interface Material { id: number; name: string }
export interface Feature { id: number; name: string }
export interface LocationOption { id: number; city: string }
