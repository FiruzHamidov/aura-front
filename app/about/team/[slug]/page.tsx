...
export async function generateMetadata(
    ...
    if (!realtor) {
        return { title: "Риелтор не найден — Aura", robots: { index: false, follow: false } };
    }

    const title = `${realtor.name} — Риелтор Aura`;
...
export default async function Page(
    ...
    const personLd: Record<string, unknown> = {
        ...
        brand: { "@type": "Organization", name: "Aura", url: SITE_URL },
    ...
    return (
        <>
            <h1 className="sr-only">{realtor.name} — Риелтор Aura</h1>
