        ...
        <div className=" space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-8 gap-4">
                ...
                {statusData.map((s, i) => (
                    <Link
                        key={`status-${i}`}
                        href={`/profile/reports/objects/?agent_id=${filters.agent_id}&date_from=${filters.date_from}&date_to=${filters.date_to}&moderation_status=${s.origLabel}`}
                ...
                <Link
                    href={`/profile/reports/objects/?agent_id=${filters.agent_id}&date_from=${filters.date_from}&date_to=${filters.date_to}&moderation_status=approved`}
                    className="block p-4 bg-white rounded-2xl shadow hover:shadow-md transition"
                >
                    <div className="flex flex-col items-center text-center gap-1">
                ...
                {soldStatusData.map((s, i) => (
                    <Link
                        key={`sold-${i}`}
                        href={`/profile/reports/objects/?agent_id=${filters.agent_id}&sold_at_from=${filters.date_from}&sold_at_to=${filters.date_to}&moderation_status=${s.origLabel}`}
                        className="block p-4 bg-white rounded-2xl shadow hover:shadow-md transition"
                    >
                        <div className="flex flex-col items-center text-center gap-1">
                            <div className="text-3xl font-bold">{s.value}</div>
