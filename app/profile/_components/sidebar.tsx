...
const ALL_ITEMS: Record<string, MenuItem> = {
  ...
  myList:    { href: '/profile/my-listings',  label: 'Мои объявления',      icon: <ListIcon className="w-5 h-5" /> },
  allList:   { href: '/profile/all-listings', label: 'Все объявления',      icon: <ListIcon className="w-5 h-5" /> },
...
export const Sidebar = () => {
  ...
  const handleLogout = async () => { try { await logoutMutation.mutateAsync(); } catch {} };
