...
export default function NewBuildingShowPage() {
    ...
    const { data: nb, isLoading } = useNewBuilding(Number(params.id));

    if (isLoading) return <div className="text-sm text-gray-500">Загрузка...</div>;
    if (!nb) return <div>Не найдено</div>;
                ...
                <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="border rounded-2xl p-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                            ...
                            <div>
                                <span className="text-gray-500">Адрес:</span> {nb.address ?? '—'}
                            </div>
                            <div>
                    ...
                    <div className="border rounded-2xl overflow-hidden">
                        ...
                        <div className="h-[320px]">
                            <YMaps query={{ lang: 'ru_RU', apikey: 'dbdc2ae1-bcbd-4f76-ab38-94ca88cf2a6f' }}>
                                ...
                                >
                                    {coords && (
                                        <Placemark geometry={coords} options={{ preset: 'islands#blueHomeIcon' }} />
                                    )}
                                </Map>
                            </YMaps>
                        </div>
