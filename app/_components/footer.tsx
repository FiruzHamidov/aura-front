...
const Footer: FC = () => {
    ...
    return (
        <footer className="bg-white rounded-t-[42px]">
                    ...
                    <div className="md:col-span-3">
                        <div className="mb-[18px]">
                            ...
                            <a
                                ...
                                className="block  font-bold text-[#1E3A8A] transition-colors"
                            >
                                +992 945 31 31 31
                            </a>
            ...
            {/* Bottom Section */}
            <div
                className="container pt-[21px] pb-[31px] text-[#353E5C] flex flex-col sm:flex-row justify-between items-center gap-4">
