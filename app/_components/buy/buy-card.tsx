                            ...
                            <div className="flex items-center">
                                ...
                                <div className="relative group inline-flex items-center">
                                    <VerifiedIcon
                                        ...
                                        fill="#0036A5"
                                        aria-label="Подтверждено aura.tj"
                                    />

                                    {/* тултип */}
                                    <div
                                        className="absolute left-1/2 -translate-x-1/2 top-full mt-1 hidden group-hover:block z-10
                  bg-[#0036A5] text-white text-xs rounded px-2 py-1 whitespace-nowrap shadow-lg"
                                    >
                                        Подтверждено aura.tj
                                    </div>
                                </div>
                            </div>
                        </div>
