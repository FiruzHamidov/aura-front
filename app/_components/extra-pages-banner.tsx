...
export const ExtraPagesBanner: FC<ExtraPagesBannerProps> = ({
  ...
  return (
    <div className="bg-white rounded-[22px] flex flex-col lg:flex-row gap-6 lg:gap-[100px] p-6 lg:p-0">
      <div className="lg:pt-10 lg:pb-[100px] lg:pl-[58px] text-left">
        ...
        <Link href={buttonLink}>
          <button className="bg-[#0036A5] rounded-full px-8 lg:px-11 py-4 lg:py-[21px] text-white hover:bg-blue-800 transition-colors text-base lg:text-lg w-full lg:w-auto">
            {buttonLabel}
          </button>
        </Link>
      </div>
