  ...
  return (
    <div className="mb-6 lg:mb-10">
      ...
      <div className="embla overflow-hidden" ref={emblaRef}>
        <div className="embla__mx-auto w-full max-w-screen-2xl px-4 sm:px-6 lg:px-8 flex gap-3 lg:gap-5 pl-4 lg:pl-[calc((100vw-1400px)/2)] pr-4 lg:pr-[calc((100vw-1400px)/2)]">
