        ...
        <div className="flex flex-col lg:flex-row gap-5">
          ...
          <div className="lg:w-3/4">
            <div className="bg-white rounded-[22px] md:p-[30px] p-4">
              ...
              <div className="mb-6">
                <button className="md:w-[705px] text-center py-5 border border-[#BAC0CC] text-[#353E5C] rounded-lg flex items-center justify-center gap-2 cursor-pointer md:text-lg transition mb-[60px]">
                ...
                <div className="grid md:grid-cols-2 justify-between gap-8 md:gap-36 mb-10">
